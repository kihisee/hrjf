    ...
    actions: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(typeof wx !="undefined"){
                // if(wx.token==""){
                //     var obj = {"UserName":load.phone,"LoginPassWord":load.password,"TerminalType":1,"OpenId":wx.OpenId,"NickName":wx.NickName,"UnionId":wx.UnionId,"IsOrigionLogin":wx.IsOrigionLogin}
                // }
                var obj = {"UserName":load.phone,"LoginPassWord":load.password,"TerminalType":1,"OpenId":wx.OpenId,"NickName":wx.NickName,"UnionId":wx.UnionId,"IsOrigionLogin":wx.IsOrigionLogin}
            }else{
