<template>
    <div class="container">
          ...
          <div class="eggmessage">
            ...
            <div class="rulebot">
              <p>活动规则</p>
              <p>1、用户每投资不低于30天的固定理财2000元，当天即可以砸一次，按2000元/次累积；投资获得的砸金蛋机会每天最多10次；</p>
              <p>2、用户有机会砸出最高1125元现金红包、10~500元投资券，0.5%~2%加息券等；</p>
              <p>3、砸金蛋机会当天23:59清零；</p>
              <p>4、活动奖品直接发放到用户账户中，奖品有效期以实际发放奖品为准；</p>
              <p>5、活动最终解释权归恒瑞金服所有<span v-if="!isIos">。</span><span v-if="isIos">，活动与苹果公司无关。</span></p>
            </div>
          </div>
...
.container{background:#ed3b58;padding-bottom:rem(60);height:rem(840)}
.container .banner{
