<template slot-scope="sss">
  <div class="allcontent">
    <heads :title="title" v-if="iswechat"></heads>
...
.allcontent{background:#fff;padding:rem(0) 0 rem(15);min-height:rem(680)}
.topcontent{width:90%;margin:0 auto;padding:rem(15) 0 0;}
