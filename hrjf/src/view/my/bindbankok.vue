...
<div class="container">
    ...
    <div class="success_box">
      <div class="icon"></div>
      <div class="successtext">恭喜您绑卡成功！</div>
      <router-link :to="'/charge'">立即充值</router-link>
      <router-link :to="'/my'" class="back">返回</router-link>
    </div>
...
.success_box .icon{width:rem(80);height:rem(80);@include bg("/static/img/my/icon_complected.png");  margin:auto;}
...
.success_box a.back{color:#de3132;border:1px solid #de3132; background:none;}
