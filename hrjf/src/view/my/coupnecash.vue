...
export default {
  ...
  created :function(){
    ...
    if(q.ver=='ios'){
      ...
      this.$http(this.$api.QueryInviteRewadIndex({}))
        .then(function(data){
          console.log(data.data.ResultData)
...
.box_bg{height:100%;@include bg("/static/img/my/couponcash.jpg"); position:absolute; overflow:hidden;top:1.1rem;left:0;bottom:1.25rem;background-size:100%;}
