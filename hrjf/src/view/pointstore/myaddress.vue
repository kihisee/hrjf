<template>
   <div id="frame">
    <div id="con">
           <div class="link_head" v-show="weixin">
            <h1>
  ...
  methods:{
    ...
    send(){
       ...
       if(!(/^1[34578]\d{9}$/.test(_this.mobile))){
        ...
        _this.tender_plan_id=query.tender_plan_id
        _this.tender=query.tender
        _this.investCount=query.investCount
        ...
        if(query.tender_plan_id){
            console.log("you")
                 this.$msg.confirm("<div style='text-align:left'>商品："+query.name+"<br />投资金额：<span style='color:#f00'>"+query.pay+"元</span><br />期限：<span style='color:#f00'>"+query.day+'天</span><br />收件人：'+_this.name+'<br />联系电话：'+_this.mobile+'<br />地址：'+_this.province+_this.city+_this.area+_this.town+_this.address+"</div>",function(){
            ...
            console.log("meiyou")
              this.$msg.confirm("<div style='text-align:left'>收件人："+_this.name+'<br />联系电话：'+_this.mobile+'<br />地址：'+_this.province+_this.city+_this.area+_this.town+_this.address+"</div>",function(){
