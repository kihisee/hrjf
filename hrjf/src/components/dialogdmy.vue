...
<div class="tanword" style="background:#fff;position:fixed;top:45%;left:50%;margin:-3.75rem 0 0 -4.5rem;width:9rem;z-index:11;border-radius: 0.125rem;" >
      ...
      <div class="adiv">
        <a class="xtop" @click="guanx()" style="width:45%">以后再说</a>
        <a class="inright" v-on:click="intrued()" style="display:inline-block;float:right;margin:0;width:45%;">开始评测</a>
      </div>
      <p style=" ine-height:0.75rem;color:#999;font-size:0.35rem;margin:0.25rem auto;width:95%;"><input type="checkbox" id="buzai" v-model="tongyi" /><label for="buzai">同意平台收集并使用您的信息用于风险评测</label></p>
</div>
